...
언리얼/블렌더 모듈러 레벨 디자인을 위한 **630×630 그리드** 타일맵 에디터 (v0.4.2).
...
> - **Shift+드래그 8방향 직선** — 가로/세로/4방향 대각선 자동 스냅, 점선 미리보기 (Photoshop 스타일)
...
| `Shift` + 드래그 | **8방향 직선** 그리기 (가로/세로/대각선 자동 스냅) |
...
- [x] **v0.4.2** — 630×630 / Shift+드래그 8방향 직선 / Alt+클릭 스포이드 / Ctrl+S 경로 기억 저장 / 밑그림 상단 정렬
